...
class Pagination {
		...
		private function first(){
			...
			if($this->page==1)
				...
				$html.="<a href='{$this->uri}&page=1' class='{$this->style}'>{$this->config["first"]}</a>";
		...
		private function prev(){
			if($this->page==1)
				...
				$html.="<a href='{$this->uri}&page=".($this->page-1)."' class='{$this->style}'>{$this->config["prev"]}</a>";
		...
		private function last(){
			if($this->page==$this->pageNum)
				...
				$html.="<a href='{$this->uri}&page=".($this->pageNum)."' class='{$this->style}'>{$this->config["last"]}</a>";
